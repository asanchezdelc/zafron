  ...
  aedes.on('publish', async function (packet, client) {    
    ...
    if (!topic.includes('data/json')) {
      ...
      try {
        ...
        console.log('Client Published: \x1b[32m' + (client ? client.id : client) + '\x1b[0m', 'to broker', packet.topic, event);
        return Promise.all([
      ...
      console.log('Client Published: \x1b[32m' + (client ? client.id : client) + '\x1b[0m', 'to broker', packet.topic, JSON.stringify(events));
